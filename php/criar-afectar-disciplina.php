...
//Verificar quais dos FORMULARIOS foi clicado
	...
	if(isset($_POST["criar_disciplina"])){
		...
		if($nome_disciplina != "" && $sigla_disciplina != ""){
			...
			if($registro >= 1){
				...
				header('Location: ../pages/dir-academico/criar-afectar-disciplina.php?erroCD=1');
				...
				$inserir = "INSERT INTO disciplina (Nome_Disciplina, Sigla) VALUES ('$nome_disciplina', '$sigla_disciplina')";
					...
					if(mysqli_query($conexao, $inserir)){
						...
						header('Location: ../pages/dir-academico/criar-afectar-disciplina.php?sucessoCD=1');
			...
			header('Location: ../pages/dir-academico/criar-afectar-disciplina.php?valorCD=1');
	...
	//Operacoes para o segundo formulario
		...
		if($registro >= 1){
			...
			header('Location: ../pages/dir-academico/criar-afectar-disciplina.php?erroACD=1');
			...
			if( (mysqli_query($conexao, $inserir)) ){
				header('Location: ../pages/dir-academico/criar-afectar-disciplina.php?sucessoACD=1');
			}else{
