    ...
    <div class="grid-x grid-padding-x">
      <div class="cell small-5 medium-4 large-3 medium-cell-block-y sidebar">
                                ...
                                <ul class="multilevel-accordion-menu vertical menu align-left grid-padding-x espacamento-nav" data-accordion-menu>
                                  ...
                                  <li>
                                    <a class="active" href="#"> <i class="fa fa-users" aria-hidden="true"> </i> Cadastrar Funcionário <span class="subitem"> </span> </a>
                                  <li>
      ...
      <div class="cell small-7 medium-8 large-9 medium-cell-block-y">
        ...
        <div class="grid-x grid-margin-x controle-panel status-panel">
            <h1> Painel Geral</h1>
              ...
              <form action="../../php/cadastrar-funcionario.php" method="POST">
                  ...
                  <div class="grid-x grid-padding-x"> 
                    <div class="small-12 medium-12 cell">
                      ...
                      <?php
                            ...
                            if($v){
                              ...
                              echo "<center> <span class='sucesso'> Funcionário Cadastrado </span> </center>";
                            }
                      ?>
                    </div>
                    <div class="small-12 medium-12 cell">
                    ...
                    <label> Perfil do Funcionário
                      <select name="perfil">
                        ...
                        <option value="director academico">Director(a) Académico</option>
                        <option value="director geral">Director(a) Geral</option>
                      </select>
                    </label>
                  </div>
                    <div class="small-12 medium-12 cell">
