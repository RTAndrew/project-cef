                                ...
                                <ul class="multilevel-accordion-menu vertical menu align-left grid-padding-x" data-accordion-menu>
                                  ...
                                  <li>
                                    ...
                                    <ul class="menu vertical sublevel-1">
                                      <li><a class="subitem" href="pages/dir-academico/matricula">Matrícula</a></li>
                                      <li><a class="subitem" href="#">Pautas</a></li>
                                    </ul>
                                  </li>
                                  <li>
                                    <a href="pages/dir-academico/criar-afectar-disciplina.php"> <i class="fa fa-book" aria-hidden="true"> </i> Criar / Afectar Disciplina <span class="subitem"> </a>
                                  </li>
                                 <li>
                                    <a href="pages/dir-academico/criar-turma"> <i class="fa fa-window-maximize" aria-hidden="true"> </i> Cadastrar Turma <span class="subitem"> </a>
                                  </li>
                                  <li>
                                    <a href="pages/dir-academico/cadastrar-professor"> <i class="fa fa-id-badge" aria-hidden="true"> </i> Cadastrar Professor <span class="subitem"> </a>
                                  </li>
                                </ul>
